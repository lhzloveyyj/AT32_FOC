...
#define DMA1_CHANNEL1_MEMORY_BASE_ADDR   (uint32_t)Motor2_AD_Value
//#define DMA1_CHANNEL1_PERIPHERAL_BASE_ADDR  0

#define DMA1_CHANNEL2_BUFFER_SIZE   2
#define DMA1_CHANNEL2_MEMORY_BASE_ADDR   (uint32_t)Motor1_AD_Value
...
#define DMA1_CHANNEL4_BUFFER_SIZE   3
...
#define DMA1_CHANNEL6_BUFFER_SIZE   3
#define DMA1_CHANNEL6_MEMORY_BASE_ADDR   (uint32_t)mt6701_2.tx_buf
//#define DMA1_CHANNEL6_PERIPHERAL_BASE_ADDR   0

#define DMA1_CHANNEL7_BUFFER_SIZE   USART1_TX_BUFFER_SIZE
#define DMA1_CHANNEL7_MEMORY_BASE_ADDR   (uint32_t)uart1_tx_buffer
//#define DMA1_CHANNEL7_PERIPHERAL_BASE_ADDR   0

#define DMA2_CHANNEL1_BUFFER_SIZE   RX_BUFFER_SIZE  
#define DMA2_CHANNEL1_MEMORY_BASE_ADDR   (uint32_t)uart1_rx_buffer
